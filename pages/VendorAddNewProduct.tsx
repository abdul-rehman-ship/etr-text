        ...
        {attributes.length>0 && 
          attributes.map((item:any)=>{
            return <>
              ...
              {
                attributesItem[item].length>0 && attributesItem[item].map((i:any)=>{
                  return <span className="m-3" style={{background:"#d3d3d3",padding:"0.3rem 1rem",borderRadius:"5px"}}>{i}</span>
                })
              }
              <br />
